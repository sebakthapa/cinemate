...
const useInfiniteScroll = ({ url, data: localData = [], dependencies = [] }) => {
  ...
  // useState has slight delay in updating. That caused it to take time to setLoading(true) and setLoadingNewPage(true) to take time resulting multiple load data to be called on scroll.

...
import { passwordResetHtml, passwordResetSuccessHtml, passwordResetText, passwordResetsuccessText } from "@/lib/emails/passwordReset"
...
export const PATCH = async (req) => {
    ...
    try {
        ...
        if (password != confirmPassword) {
            return NextResponse.json({ field: "confirmpassword", error: "Confirm Password didn't match." }, { status: 403 });
        }

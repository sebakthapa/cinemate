...
function Signup({ searchParams }) {
    ...
    const handleSignup = async () => {
        if (email && password && confirmPassword) {
            if (emailValidation.status === "valid" && passwordValidation.status === "valid" && confirmPasswordValidation.status === "valid") {
                            ...
                            </p>
                            {
                                showMoreRecaptchaMessage ? (
                                    <span className={styles.moreMessage}>
                                        <br /><br />
                                        The information collected by Google reCAPTCHA is subject to the Google <a rel="noreferrer" target="_blank" href="https://policies.google.com/privacy">Privacy Policy</a>  and <a rel="noreferrer" target='_blank' href="https://policies.google.com/terms">Terms of Service</a> , and is used for providing, maintaining, and improving the reCAPTCHA service and for general security purposes (it is not used for personalized advertising by Google).
                                    </span>
                                ) : (
